...
addition, you have an operation called flip, which changes a single x to y or
...
all x's come before all y's. In the preceding example, it suffices to flip the
